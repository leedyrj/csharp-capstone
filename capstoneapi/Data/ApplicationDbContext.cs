    ...
    public class ApplicationDbContext : IdentityDbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            Employee user5 = new Employee
            {
                ...
                LastName = "Lemmon",
                UserName = "emlem",
                NormalizedUserName = "EMLEM",
                Email = "e@lemmon.com",
                NormalizedEmail = "E@LEMMON.COM",
                EmailConfirmed = true,
                LockoutEnabled = false,
                SecurityStamp = Guid.NewGuid().ToString("D"),
                DepartmentId = 1
            ...
            var passwordHash5 = new PasswordHasher<Employee>();
            user5.PasswordHash = passwordHash5.HashPassword(user5, "emlemRocks8*");
            modelBuilder.Entity<Employee>().HasData(user5);
        }
    }
}